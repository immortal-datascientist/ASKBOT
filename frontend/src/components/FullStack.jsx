...
import {
  getPdfFiles,
  getFullStackDayFiles,
  getFullStackSchedule
} from "../api/api";
...
export default function FullStack() {
  ...
  /* ---------------- LOAD FULLSTACK SCHEDULE PDFs ---------------- */
  useEffect(() => {
    (async () => {
      const data = await getFullStackSchedule();
  ...
  const handleSelectDay = async (day) => {
    ...
    const data = await getFullStackDayFiles(day);
  ...
  return (
    ...
    >
      <h1 style={{ fontWeight: 800, color: "#04352d" }}>Full-Stack Development</h1>
      ...
      {selectedDay && (
        <div style={{ marginTop: "40px", paddingBottom: "60px" }}>
          ...
          >
            Day {selectedDay} – Full-Stack Materials
          </h2>
      ...
      {/* POPUP */}
      <FinaclePopup module="fullstack" setSelectedDay={handleSelectDay}  dayCount={60}/>
...
>
        <h3 className="fw-bold mb-3">Full-Stack Schedule</h3>
